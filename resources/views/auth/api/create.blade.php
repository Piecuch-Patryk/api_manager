...
<div class="container p-5">
    <form method="POST" action="{{ route('api.store') }}" class="row needs-validation justify-content-center align-items-center" novalidate>
        ...
        <div class="col-12 col-md-8 col-lg-6 mb-3">
            ...
            <input type="text" class="form-control" id="api-name" name="api-name" value="{{old('api-name')}}" required>
        ...
        <div class="col-12 col-md-8 col-lg-6 mb-3">
            ...
            <textarea type="" class="form-control" id="api-desc"  name="api-desc" required>
                {{old('api-desc')}}
            </textarea>
            <div class="invalid-feedback">
        ...
        <div class="col-12 col-md-8 col-lg-6 mb-3">
            ...
            <input type="text" class="form-control" id="api-url"  name="api-url" value="{{old('api-url')}}" required>
            <div class="invalid-feedback">
        ...
        <div class="col-12 col-md-8 col-lg-6 mb-3">
            ...
            <input type="text" class="form-control" id="api-endpoint-name"  name="api-endpoint-name" value="{{old('api-endpoint-name')}}" required>
            <div class="invalid-feedback">
        ...
        <div class="col-12 col-md-8 col-lg-6 mb-3">
            ...
            <textarea class="form-control" id="api-endpoint-desc"  name="api-endpoint-desc" required>
                {{old('api-endpoint-desc')}}
            </textarea>
            <div class="invalid-feedback">
        ...
        <div class="col-12 col-md-8 col-lg-6 mb-3">
            ...
            <input type="text" class="form-control" id="api-endpoint"  name="api-endpoint" value="{{old('api-endpoint')}}" required>
            <div class="invalid-feedback">
